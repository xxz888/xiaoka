...
- (id)initWithText:(NSString *)text_
{
    if (self = [super init])
    {
        ...
        text = [text_ copy];
        //不知道这么写是不是错的，如果以后Toast出现问题，多半是这里的原因
        UIFont *font = [UIFont boldSystemFontOfSize:14];
        CGSize textSize = [text boundingRectWithSize:CGSizeMake(280, MAXFLOAT) options:NSStringDrawingUsesLineFragmentOrigin | NSStringDrawingUsesFontLeading attributes:nil context:nil].size;
