...
@interface HCChangePhoneController ()<UITableViewDelegate, UITableViewDataSource , UITextFieldDelegate>
...
@implementation HCChangePhoneController
...
- (void)getDeterMineAction{
    ...
    [dic setValue:model1.content forKey:@"username"];//手机号
    [dic setValue:model0.content forKey:@"smsCode"];//短信码
...
//        _top_lab.text = @"您正在修改133***8595的登录账号";
